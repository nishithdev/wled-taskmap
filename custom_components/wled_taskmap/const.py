...
CONF_COND_ENTITY = "cond_entity"  # optional: rule active only while this...
CONF_COND_STATE = "cond_state"  # ...entity is in this state (default "on")
CONF_NOTIFY = "notify"  # optional notify service (without "notify." prefix)
